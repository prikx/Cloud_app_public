...
// Initialize routes
app.use('/passthrough/users', userRoutes);
app.use('/passthrough/auth', authRoutes);
app.use('/passthrough/surveys', surveyRoutes);
app.use('/passthrough/adaptions', adaptionRoutes);
app.use('/passthrough/health', healthRouter)
app.use('/passthrough/files/',generateFileRoutes)
